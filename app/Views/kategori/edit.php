            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $kategori['kategori_nama']; ?>" name="kategori_nama" id="kategori_nama" class="form-control <?= $validation->hasError('kategori_nama') ? 'is-invalid' : '' ?>" placeholder="Enter fullname...">
